...
\033[1;91m☞ Auther     : MUHAMMAD ZAI KING  ABDULLAH 
\033[1;92m☞ WhatsApp   : 03185005207
\033[1;95m☞ FACEBOOK    : https://www.facebook.com/profile.php?id=100084139054726
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update B4 Abdullah Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' B4 Abdullah WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('🔓User Name☆ Abdullah✓')
	    psb('🔓Password ☆ Abdullah✓')
